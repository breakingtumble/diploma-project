  ...
  return (
    <div style={{ width: "100vw", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f6f8fa" }}>
      <form onSubmit={handleSubmit} style={{ minWidth: 340, background: '#fff', borderRadius: 16, boxShadow: '0 4px 32px rgba(0,0,0,0.10)', padding: '2.5rem 2.5rem 2rem 2.5rem', display: "flex", flexDirection: "column", gap: 20, alignItems: 'stretch' }}>
        <h2 style={{ textAlign: 'center', marginBottom: 8, fontWeight: 700, fontSize: '2rem', color: '#222' }}>Login</h2>
        ...
        <button type="submit" style={{ background: '#0094FF', color: '#fff', border: 'none', borderRadius: 8, padding: '0.75rem', fontWeight: 700, fontSize: '1.1rem', cursor: 'pointer', marginTop: 8, marginBottom: 4, boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>Login</button>
        ...
        <div style={{ textAlign: 'center', marginTop: 12 }}>
          ...
          <span style={{ color: '#0094FF', fontWeight: 600, cursor: 'pointer', textDecoration: 'underline' }} onClick={() => navigate('/register')}>
            Register
          </span>
        </div>
      </form>
